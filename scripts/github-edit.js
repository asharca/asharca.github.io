hexo.extend.filter.register('after_post_render', data => {
  ...
  const editLink = `
<div class="post-edit-link" style="margin-top: 16px; text-align: right;">
  <a href="${editUrl}" target="_blank" rel="noopener" style="color: #0969da; text-decoration: none; display: inline-flex; align-items: center; font-size: 14px;">
